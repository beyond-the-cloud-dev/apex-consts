...
export const footerData = {
  company: {
    ...
    description:
      "Helping enterprise teams run Salesforce that's reliable, secure, and predictable.",
  },
  services: [
    {
      label: "Technical Debt Resolution",
      href: "https://beyondthecloud.dev/services#tech-debt",
    },
    {
      label: "Agentforce Implementation",
      href: "https://beyondthecloud.dev/services#agentforce",
    },
  ...
  openSource: {
    parent: {
      label: "Apex Fluently",
      href: "https://apexfluently.beyondthecloud.dev",
      logo: "/images/libs/apex-fluently.png",
    },
    children: [
      {
        id: "soql-lib",
        label: "SOQL Lib",
        href: "https://soql.beyondthecloud.dev",
        logo: "/images/libs/soql-lib.png",
      },
      {
        id: "dml-lib",
        label: "DML Lib",
        href: "https://dml.beyondthecloud.dev",
        logo: "/images/libs/dml-lib.png",
      },
      {
        id: "async-lib",
        label: "Async Lib",
        href: "https://async.beyondthecloud.dev",
        logo: "/images/libs/async-lib.png",
      },
      {
        id: "http-mock",
        label: "HTTP Mock",
        href: "https://httpmock.beyondthecloud.dev",
        logo: "/images/libs/http-mock-lib.png",
      },
      {
        id: "apex-consts",
        label: "Apex Consts",
        href: "https://apexconsts.beyondthecloud.dev",
        logo: "/images/libs/apex-consts.png",
      },
      {
        id: "cache-manager",
        label: "Cache Manager",
        href: "https://cachemanager.beyondthecloud.dev",
        logo: "/images/libs/cache-manager.png",
      },
      {
        id: "test-lib",
        label: "Test Lib",
        href: "https://testlib.beyondthecloud.dev",
        logo: "/images/libs/test-lib.png",
      },
      {
        id: "trigger-lib",
        label: "Trigger Lib",
        href: "https://trigger.beyondthecloud.dev",
        logo: "/images/libs/trigger-lib.png",
      },
      {
        id: "callout-lib",
        label: "Callout Lib",
        href: "https://callout.beyondthecloud.dev",
  ...
  social: [
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/@BeyondTheCloudDev",
      icon: "youtube",
    },
  ],
  legal: {
